...
# File paths
tf.flags.DEFINE_string('test_data_file', './dataTest_data.xlsx', 'Test data file path')
tf.flags.DEFINE_string('run_dir', 'E:./runs/1561281249', 'Restore the model from this run')
